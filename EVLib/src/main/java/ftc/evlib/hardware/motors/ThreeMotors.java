...
public class ThreeMotors extends NMotors {
    public ThreeMotors(Motor motor1, Motor motor2, Motor motor3, boolean useSpeedMode, Motor.StopBehavior stopBehavior, Velocity maxRobotSpeed) {
        super(ImmutableList.of(motor1, motor2, motor3), useSpeedMode, stopBehavior, maxRobotSpeed);
    }
