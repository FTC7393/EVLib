...
public class VuforiaFrameGrabberInit extends VuforiaLocalizerImpl {
     ...
     * @return the ResultReceiver that will contain the VuforiaFrameGrabberInit object
     */
    public static ResultReceiver<VuforiaFrameGrabberInit> initInNewThread(final String licenseKey, final @IdRes int cameraMonitorViewIdParent, final int widthRequest, final int heightRequest) {
        //create the ResultReceiver that will store the VuforiaFrameGrabberInit
        final ResultReceiver<VuforiaFrameGrabberInit> receiver = new BasicResultReceiver<>();

        //start the init in a new thread
        new Thread(new Runnable() {
            @Override
            public void run() {
                receiver.setValue(VuforiaFrameGrabberInit.init(licenseKey, cameraMonitorViewIdParent, widthRequest, heightRequest));
            }
        }).start();
...
//        VuforiaLocalizer.Parameters params = new VuforiaLocalizer.Parameters();
    ...
    public VuforiaFrameGrabberInit(Parameters params, int widthRequest, int heightRequest) {
        this(params, widthRequest, heightRequest, FrameGrabber.CameraOrientation.PORTRAIT_UP, false);
    }

    public VuforiaFrameGrabberInit(Parameters params, FrameGrabber.CameraOrientation cameraOrientation, int widthRequest, int heightRequest) {
        this(params, widthRequest, heightRequest, cameraOrientation, false);
    }

    public VuforiaFrameGrabberInit(Parameters params, boolean ignoreOrientationForDisplay, int heightRequest, int widthRequest) {
